...
try {
  ...
  const requiredTables = [
    ...
    "student_model_mastery_evidence",
    "student_model_opportunities",
    "student_model_revision_decisions",
    "student_model_revision_suggestions",
  ...
  const requiredTriggers = [
    ...
    "assignment_item_exercise_is_scoped",
    "assignment_item_grouping_is_immutable",
    ...
    "exercises_are_immutable",
    "flat_assignment_items_receive_default_exercise",
    ...
    "live_student_model_mastery_timestamp_is_current",
    "live_student_model_opportunity_timestamp_is_current",
    ...
    "student_model_consistency_counts_are_valid",
    "student_model_mastery_evidence_cannot_be_deleted_directly",
    "student_model_mastery_evidence_is_immutable",
    "student_model_mastery_evidence_matches_student",
    "student_model_opportunities_are_immutable",
    "student_model_opportunities_cannot_be_deleted_directly",
    "student_model_opportunities_match_student",
    "student_model_revision_ai_run_is_scoped",
    "student_model_revision_decisions_are_immutable",
    "student_model_revision_decisions_cannot_be_deleted_directly",
    "student_model_revision_suggestion_is_scoped",
    "student_model_revision_suggestion_null_shape",
    "student_model_revision_suggestions_are_immutable",
    "student_model_revision_suggestions_cannot_be_deleted_directly",
    ...
    "teacher_item_reviews_are_immutable",
